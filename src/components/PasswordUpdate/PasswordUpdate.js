...
function PasswordUpdate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://user-login-api-868610282.ap-south-1.elb.amazonaws.com/users/passwordUpdate', { token, oldPass: oldPass, newPass: newPass, confNewPass: confPass })
            .then((response) => {
    ...
    return (
        <div>
            ...
            <div className='w-full 2xl:w-4/5 flex flex-row items-center justify-items-center gap-x-4'>
                ...
                <button type="submit" className='w-full 2xl:w-4/5 bg-fuchsia-600 disabled:bg-neutral-300 text-white disabled:text-neutral-500 p-2.5 rounded-full font-medium text-xl'>Change Password</button>
            </form>
        </div>
    )
}
